...
class Space():
    ...
    def hill_climb(self, maximum=None, image_prefix=None, log=False):
        ...
        # Start by initializing hospital randomly
        self.hospitals = set()
        ...
        #Continues until we reach maximum number of iterations
    ...
    def get_cost(self, hospitals):
        """Calculates sum of distance from houses to nearest hospital."""
        cost = 0
        for house in self.houses:
            cost += min(
    ...
    def output_image(self, filename):
        ...
        img = Image.new(
            ...
            (self.width * cell_size,
             self.height * cost_size + cost_size + padding * 2),
            "white"
        )
        ...
        for i in range(self.height):
            for j in range(self.width):
                ...
                rect: list[Union[tuple[int, int], tuple[bool, bool]]] = [
...
hospitals = s.hill_climb(image_prefix="hospitals_review", log=True)